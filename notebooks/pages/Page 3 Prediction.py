...
with open('models/OneHotEncoder.pkl', 'rb') as file: 
...
if button_clicked_metrics:
    with open('models/SVC.plk', 'rb') as file:
        svc_model = pickle.load(file)

    with open('models/Bagging.plk', 'rb') as file:
        bagging_model = pickle.load(file)

    with open('models/GradientBoosting.plk', 'rb') as file:
        gradient_model = pickle.load(file)

    with open('models/Stacking_model.plk', 'rb') as file:
